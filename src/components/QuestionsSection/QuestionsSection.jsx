...
const QuestionsSection = () => {
  return (
    <div className="flex flex-col items-center justify-center px-6 md:px-16 lg:px-24 bg-white text-center lg:pt-20 pb-10">
      <Typography
        variant="h2"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <Card className="p-6 shadow-lg border border-gray-300 bg-white rounded-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          ...
          >
            Our AI generates questions similar to the actual NEET exam, helping
            you prepare more effectively for the real challenge.
          </Typography>
        </Card>
