...
const SuggesionFlow = () => {
  return (
    <>
      <Divider />
      <div className="flex flex-col items-center justify-center min-h-screen w-full bg-white dark:bg-black text-center px-4 sm:px-10 md:px-16 lg:px-24 xl:px-32 pt-20 pb-20 transition-colors duration-300">
        <Typography
          variant="h2"
