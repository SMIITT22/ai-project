...
const QuestionsSection = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-white via-white to-white dark:from-gray-950 dark:via-black dark:to-gray-950">
        <div className="flex flex-col items-center justify-center min-h-screen w-full px-6 md:px-20 lg:px-32 text-center pt-20 pb-20 transition-colors duration-300">
          <Typography
            variant="h2"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full px-4 md:px-12">
            <Card className="p-6 shadow-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg transform transition-all hover:scale-105 hover:shadow-2xl">
              ...
              >
                ...
                create at once, we let you generate as many questions as you
                need with a single prompt. No limits, no restrictions.
              </Typography>
            </Card>
            <Card className="p-6 shadow-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg transform transition-all hover:scale-105 hover:shadow-2xl">
              <div className="mb-4">
              ...
              >
                ...
                format instantly. No additional formatting required—just
