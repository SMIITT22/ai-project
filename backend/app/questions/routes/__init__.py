...
from .generate_questions_from_text import text_generate_router 
...
questions_router.include_router(text_generate_router, prefix="/generate_questions_from_text", tags=["questions"])
